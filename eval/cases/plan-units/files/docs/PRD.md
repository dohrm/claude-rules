...
| 06 | Recipient notifications | a recipient is told when the parcel is out for delivery |
| 07 | Depot handover | a parcel changes depot and keeps one continuous history |
| 08 | Bulk import | a shipper uploads tomorrow's manifest before any scan exists |
| 09 | Audit export | support reconstructs what a dispatcher saw at a given time |
