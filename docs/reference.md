...
[Back to the quick start](../README.md). Paths and shell commands below are relative
to the repository root. Read the section relevant to your task.

- [Workflow and documents](#the-workflow-these-assets-encode)
- [Installation and profiles](#install)
- [Daily commands](#the-commands-you-end-up-with)
- [Installer targets](#targets)
- [Repository checks](#verifying-the-factory-itself)
